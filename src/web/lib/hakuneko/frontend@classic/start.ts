...
@customElement('hakuneko-start')
export class HakunekoStart extends LitElement {
    static styles = [themeStyles, css`
        ...
        .show { display: block; }
        .hide { display: none; }
        h1 { font-size: 1.5em; margin-top: 0; margin-bottom: 0; vertical-align: center; }
        ...
        .logo { margin-right: 1em; border-radius: 10%; }
    `];
